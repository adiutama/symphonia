...
The git **branch** may use that same string, an Operator-supplied name, or a different name afterward. Folder and branch are not required to stay in sync — see ADR 0018.
