...
Starting a Worktree’s Main CLI runs that resolved command with cwd = the Worktree and the Workspace Secret Store's Enabled Env Vars injected (spawn-time in v1).
